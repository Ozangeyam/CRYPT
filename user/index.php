                ...
                <div class="col-md-4 col-md-offset-4">
                    ...
                    if (isset($_POST['sign-up'])) {
                        ...
                        if ($register != false) {
                            $to = $_POST['email'];
                            $fname = $_POST['fname'];
                            // $name = "Cryptbits Investment Support";
                                      ...
                                      <table role='presentation' style='width:94%;max-width:600px;border:none;border-spacing:0;text-align:left;font-family:Arial,sans-serif;font-size:16px;line-height:22px;color:#363636;'>
                                        <tr>
                                          <td style='padding:40px 30px 30px 30px;text-align:center;font-size:24px;font-weight:bold;'>
                                            <a href='http://www.Cryptbits.trade/' style='text-decoration:none;'><img src='$site_url/img/up_logo.png' width='165' style='width:80%;max-width:165px;height:auto;border:none;text-decoration:none;color:#ffffff;'></a>
                                          </td>
                                        </tr>
                                        <!-- <tr>
                                          <td style='padding:30px;background-color:#ffffff;'>
                                            <h1 style='margin-top:0;margin-bottom:16px;font-size:26px;line-height:32px;font-weight:bold;letter-spacing:-0.02em;'>Welcome to Cryptbits Capital!</h1>
                                        ...
                                        <tr>
                                          <td style='padding:35px 30px 11px 30px;font-size:0;background-color:#ffffff;border-bottom:1px solid #f0f0f5;border-color:rgba(201,201,207,.35);'>
                                            ...
                                            <div class='col-sml' style='display:inline-block;width:100%;max-width:145px;vertical-align:top;text-align:left;font-family:Arial,sans-serif;font-size:14px;color:#363636;'>
                                              <img src='$site_url/img/up_logo.png' width='115' height='90' alt='' style='width:80%;max-width:115px;margin-bottom:20px;'>
                                            </div>
                                            <!--[if mso]>
                                            </td>
                        ...
                        <div class="panel-body">
                            <form role="form" action="<?php echo($_SERVER['PHP_SELF']); ?>" method="post">
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        <input class="form-control" placeholder="Referrer ID(Optional)" name="ref" type="text" value="<?php if (isset ( $_GET ['ref'])) {
    echo $_GET['ref'];
} ?>" autofocus>
                                    </div>
                                    <div class="form-group">
